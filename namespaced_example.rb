...
class CustomOperatorController < Rubernetes::Operator
  ...
  # Event callback when a custom resource is added, you can add your cutom logic
  # here that will be triggered when a custom resource is added
  ...
  # Event callback when a custom resource is modified, you can add
  # your cutom logic here that will be triggered when a custom resource is modified
  # @param event [Hash] Event from the watcher that contains all information about
  # the custom resource that you will need
  def modified(event)
  ...
  # Event callback when a custom resource is deleted, you can add
  # your cutom logic here that will be triggered when a custom resource is deleted
  # @param event [Hash] Event from the watcher that contains all information about
  # the custom resource that you will need
  def deleted(_event)
